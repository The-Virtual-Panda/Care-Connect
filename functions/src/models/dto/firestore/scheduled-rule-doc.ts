...
export function toScheduledRuleDoc(
    ...
    return {
        ...
        startDate: Timestamp.fromDate(p.startDate as Date),
        endDate: p.endDate ? Timestamp.fromDate(p.endDate as Date) : undefined,
...
export function fromScheduledRuleDoc(doc: ScheduledRuleDoc, id: string): ScheduledRule {
    return {
        ...
        endDate: doc.endDate ? doc.endDate.toDate() : undefined,
        freq: doc.freq,
